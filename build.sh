...
aarch64-linux-gnu-gcc -ffreestanding -c src/lib/mmio/mmio.c -o build/lib/mmio.o
aarch64-linux-gnu-ld -nostdlib -T linker.ld build/boot.o build/kernel.o build/lib/mmio.o -o build/kernel.elf
